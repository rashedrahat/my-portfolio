...
style={{scaleY: scrollYProgress}}
  ...
  "  />
        ...
        <Details
              position="SDE II ReactJS Engineer"
              company="Shikho"
              companyLink="https://shikho.com"
              time="Dec 2021 - Present"
              type="Full-time"
              address="Banani, Dhaka"
              work="Highly accomplished professional with a track record of saving $1M annually through third-party tool integration, improving in-house product functionality by 15-25%, staying up-to-date with new release versions, and guiding junior developers in design, development, deployment, and maintenance."
            />
